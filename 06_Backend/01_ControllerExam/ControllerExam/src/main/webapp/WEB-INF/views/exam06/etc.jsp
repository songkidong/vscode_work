...
<%-- TODO: c library import --%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%-- TODO: fn library import--%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%>
<%-- TODO: fmt library import --%>
...
<%--     1) 사용법 : ${fn:contains(chars, name)} : chars 에 name 값이 있으면 true 없으면 false --%>
