 ...
 *      기본 생성자 : 클래스 선언(정의) 시 컴파일러에 의해 자동으로 추가되는 생성자
...
//    2) 생성자함수는 여러개를 만들 수 있음 : 생성자 오버로딩(overloading)
//    사용법 : 클래스명(){}
    Car() {};

//    TODO: 2nd 생성자 함수 : 개발자가 정의하기 나름(매개변수 있고 자유롭게 정의)
//      **) 오버로딩: 같은 이름을 가진 함수를 여러개 정의할 수 있게 하는 기능(객체지향언어만 가능)
    Car(String color, int cc) {
//    TODO: 생성자 함수의 역할 : 속성 초기화(변수에 값을 처음 넣어두는 행위)를 담당
        col = color;
        ccNum = cc;
    }
}
